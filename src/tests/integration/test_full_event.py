...
class TestFullEvent:
    ...
    def _setup_base(self):
        ...
        self.item_transport = Item.objects.create(name='Public transport', description='Public transport ticket', initial_stock=100, is_receipt=True)
        ...
        ProductItem.objects.create(product=self.prod_transport, item=self.item_transport, amount=1)
    ...
    def _simulate_session(self, full_sales, full_preorders, full_reversals, full_preorder_reversals,
                          ...
                          d_transport_sales, d_transport_preorders, d_transport_reversals, d_transport_preorder_reversals,
