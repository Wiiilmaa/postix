...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.BooleanField(default=False, help_text='Block everybody except for superuser users from using the server.', verbose_name='Maintenance mode'),
        ),
        migrations.AlterField(
            model_name='asset',
            name='asset_type',
            field=models.CharField(choices=[('box', 'Box'), ('inlay', 'Inlay'), ('bag', 'Bag'), ('counting_board', 'Counting board')], max_length=190, verbose_name='Type'),
        ),
        migrations.AlterField(
            model_name='asset',
            name='description',
