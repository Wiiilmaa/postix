...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        keys = [('date', 'Datum'), ('time', 'Uhrzeit'), ('direction', 'Richtung'), ('amount', 'Betrag'), ('entity', 'Quelle/Ziel'), ('entity_detail', 'Detail'), ('supervisor', 'Person'), ('user', 'Einlieferer/Empfänger'), ('checksum', 'Prüfsumme')]
